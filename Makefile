...
medir.o: globals.o write_conf.o medir.f90
minim.o: globals.o control.h minim.f90
...
force.o: globals.o intra_molec.o force.f90
final.o: ziggurat.o globals.o write_conf.o medir.o final.f90

main.o: main.f90 globals.o init.o force.o fluid_wall.o \
		verlet_positions.o verlet_velocities.o medir.o final.o
