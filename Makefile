...
OBJS = ziggurat.o globals.o write_conf.o lang.o init.o force.o intra_molec.o \
	   fluid_wall.o verlet_positions.o verlet_velocities.o final.o main.o minim.o medir.o
...
final.o: ziggurat.o globals.o write_conf.o medir.o control.h final.f90
